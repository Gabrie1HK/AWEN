  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
      ...
      <div className="kpi-grid">
        ...
        <StatCard icon={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12"/></svg>} value={reportSummary.successRate} label="Tasa de Éxito" color="#10b981" />
        <StatCard icon={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>} value={reportSummary.returnRate} label="Tasa de Devolución" color="#ef4444" />
      </div>
            ...
            <div className="donut-chart">
              <svg width="180" height="180" viewBox="0 0 180 180">
                {Object.entries(statusCounts).map(([status, count], i) => {
                  ...
                  const dashArray = `${pct * circumference} ${circumference * (1 - pct)}`
